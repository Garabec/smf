...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'author_manager' => 'getAuthorManagerService',
            ...
            'post_manager' => 'getPostManagerService',
    ...
    /**
     * Gets the 'author_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Blog\CoreBundle\Services\AuthorManager A Blog\CoreBundle\Services\AuthorManager instance
     */
    protected function getAuthorManagerService()
    {
        return $this->services['author_manager'] = new \Blog\CoreBundle\Services\AuthorManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bMZ-hLtKlm', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yzwUIhjcNm', 0, 'giCkSdq6n71gWIVL-JoFra', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_00000000121ae69a00007f9bb95b5c44b73f48d9079634abf189d7d6feec6adb(
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Blog/CoreBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Blog/ModelBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Blog\\CoreBundle\\Entity');
        $c->addDriver($b, 'Blog\\ModelBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('CoreBundle' => 'Blog\\CoreBundle\\Entity', 'ModelBundle' => 'Blog\\ModelBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6d16f474d35cbb67a9ebc35112c77372b378aa089f042ff867aec0864c4fb08e');
    ...
    /**
     * Gets the 'post_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Blog\CoreBundle\Services\PostManager A Blog\CoreBundle\Services\PostManager instance
     */
    protected function getPostManagerService()
    {
        return $this->services['post_manager'] = new \Blog\CoreBundle\Services\PostManager($this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('GgXKKCD3Sx', NULL, 'giCkSdq6n71gWIVL-JoFra', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, 'blog_core_post_index'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'blog_admin_security_logout'));
        ...
        $i->setOptions(array('login_path' => 'blog_admin_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $j->setOptions(array('login_path' => 'blog_admin_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}), 'secured_area', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $e, 'secured_area', $i, $j, array('check_path' => 'blog_admin_security_loginChek', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58aeed2c282b11.63273671', $b, $g), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'blog_admin_security_login', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('secured_area', 'security.user_checker', 'security.request_matcher.6240387b66387290be729a1c3e1c95979e9c0a1ea65a10eef472213c1f8dea9b5f958356', true, false, 'security.user.provider.concrete.in_memory', 'secured_area', 'security.authentication.form_entry_point.secured_area', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/src/Blog/CoreBundle/Resources/translations/messages.en.yml'), 4 => ($this->targetDirs[3].'/src/Blog/AdminBundle/Resources/translations/messages.en.yml')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/src/Blog/CoreBundle/Resources/translations/messages.ru.yml'), 4 => ($this->targetDirs[3].'/src/Blog/AdminBundle/Resources/translations/messages.ru.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Blog\CoreBundle\TwigExtensions\TransPlural($a));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Blog/ModelBundle/Resources/views'), 'Model');
        $instance->addPath(($this->targetDirs[3].'/src/Blog/AdminBundle/Resources/views'), 'Admin');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-dddq6sETp', 0, 'giCkSdq6n71gWIVL-JoFra', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => NULL, 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/')));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('secured_area', 'blog_admin_security_logout', 'logout', '_csrf_token', NULL);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Blog/CoreBundle'),
                    'namespace' => 'Blog\\CoreBundle',
                ),
                'ModelBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Blog/ModelBundle'),
                    'namespace' => 'Blog\\ModelBundle',
                ),
                'AdminBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Blog/AdminBundle'),
...
class DoctrineORMEntityManager_00000000121ae69a00007f9bb95b5c44b73f48d9079634abf189d7d6feec6adb extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58aeed2d870c7238298810 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58aeed2d870f2316395147 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58aeed2d8705d092929345 = array(
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getConnection', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getConnection();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getMetadataFactory', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getMetadataFactory();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getExpressionBuilder', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getExpressionBuilder();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'beginTransaction', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->beginTransaction();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getCache', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getCache();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'transactional', array('func' => $func), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->transactional($func);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'commit', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->commit();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'rollback', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->rollback();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getClassMetadata', array('className' => $className), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getClassMetadata($className);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'createQuery', array('dql' => $dql), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->createQuery($dql);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'createNamedQuery', array('name' => $name), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->createNamedQuery($name);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'createQueryBuilder', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->createQueryBuilder();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'flush', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->flush($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'clear', array('entityName' => $entityName), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->clear($entityName);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'close', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->close();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'persist', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->persist($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'remove', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->remove($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'refresh', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->refresh($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'detach', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->detach($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'merge', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->merge($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->copy($entity, $deep);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getRepository($entityName);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'contains', array('entity' => $entity), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->contains($entity);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getEventManager', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getEventManager();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getConfiguration', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getConfiguration();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'isOpen', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->isOpen();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getUnitOfWork', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getUnitOfWork();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getProxyFactory', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getProxyFactory();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'initializeObject', array('obj' => $obj), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->initializeObject($obj);
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'getFilters', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->getFilters();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'isFiltersStateClean', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->isFiltersStateClean();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'hasFilters', array(), $this->initializer58aeed2d870f2316395147);

        return $this->valueHolder58aeed2d870c7238298810->hasFilters();
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 = $initializer;
    }
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__get', array('name' => $name), $this->initializer58aeed2d870f2316395147);

        if (isset(self::$publicProperties58aeed2d8705d092929345[$name])) {
            return $this->valueHolder58aeed2d870c7238298810->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58aeed2d870c7238298810;
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58aeed2d870f2316395147);
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__isset', array('name' => $name), $this->initializer58aeed2d870f2316395147);
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__unset', array('name' => $name), $this->initializer58aeed2d870f2316395147);
    ...
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__clone', array(), $this->initializer58aeed2d870f2316395147);

        $this->valueHolder58aeed2d870c7238298810 = clone $this->valueHolder58aeed2d870c7238298810;
    }

    public function __sleep()
    {
        $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, '__sleep', array(), $this->initializer58aeed2d870f2316395147);

        return array('valueHolder58aeed2d870c7238298810');
    }
    ...
    {
        return $this->initializer58aeed2d870f2316395147;
    }
    ...
    {
        return $this->initializer58aeed2d870f2316395147 && $this->initializer58aeed2d870f2316395147->__invoke($this->valueHolder58aeed2d870c7238298810, $this, 'initializeProxy', array(), $this->initializer58aeed2d870f2316395147);
    }
    ...
    {
        return null !== $this->valueHolder58aeed2d870c7238298810;
    }
    ...
    {
        return $this->valueHolder58aeed2d870c7238298810;
    }
