...
class Comment extends \Blog\ModelBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'body', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Comment' . "\0" . 'post'];
        }
