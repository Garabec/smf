...
class Post extends \Blog\ModelBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'slug', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'body', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'author', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Post' . "\0" . 'comments'];
        }
