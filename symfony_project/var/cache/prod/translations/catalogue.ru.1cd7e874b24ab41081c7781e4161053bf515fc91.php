...
$catalogue = new MessageCatalogue('ru', array (
  ...
  'messages' => 
  array (
    'blog.core.author' => 'Автор',
    'blog.core.author_posts' => 'Автор постов',
    'blog.core.post.comment.on' => 'Опубликовано',
    'blog.core.post.comment.by' => 'Автор',
    'blog.core.post.comment.title' => 'Комментарии',
    'blog.core.post.comments' => ' {0} Будьте первым кто прокомментировал| {1} %count% комментарий| {2} %count% комментария| {3} %count% комментариев',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'blog.core.author' => 'Author',
    'blog.core.author_posts' => 'Author posts',
    'blog.core.post.comment.name' => 'Author name',
    'blog.core.post.comment.body' => 'Your message',
    'blog.core.post.comment.send' => 'Send',
    'blog.core.post.comment.write' => 'Please write your comment',
    'blog.core.post.comment.on' => 'Created',
    'blog.core.post.comment.by' => 'Author',
    'blog.core.post.comment.title' => 'Comments',
    'blog.core.post.comments' => ' {0} Not comments| {1} %count% comment| ]1,Inf] %count% comments',
    'blog.admin.security.title' => 'Admin panel',
    'blog.admin.security.name' => 'Administration panel',
  ),
));
