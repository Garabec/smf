...
class __TwigTemplate_a97cf165e458a97f5a4a1fcb4f40383d3f4a224fd68abdfd799dbbb70cd81f21 extends Twig_Template
{
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("blog_admin_post_edit", array("id" => $this->getAttribute((isset($context["post"]) ? $context["post"] : null), "id", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
";
    ...
    {
        return new Twig_Source("", "AdminBundle:post:show.html.twig", "/home/ubuntu/workspace/symfony_project/src/Blog/AdminBundle/Resources/views/post/show.html.twig");
    }
}
