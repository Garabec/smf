...
class Author extends \Blog\ModelBundle\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Author' . "\0" . 'name', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Author' . "\0" . 'slug', '' . "\0" . 'Blog\\ModelBundle\\Entity\\Author' . "\0" . 'posts'];
        }
